...
impl<'a> ApplicationHandler for App<'a> {
    ...
    fn window_event(&mut self, event_loop: &ActiveEventLoop, _id: WindowId, event: WindowEvent) {
        ...
        let mut update_username_label = |clear_input: bool| {
            ...
            let username_text = if let Some(comp) = 
                    self.manager.find_component_by_id_mut("username_input") 
                {
            ...
            let label_update = ComponentUpdate::SetText(
            ...
            if clear_input {
                let clear_update = ComponentUpdate::SetText("username_input".to_string(), String::new());
                updates.push(clear_update);

                // Give visual feedback on the button
                let button_update = ComponentUpdate::SetText("connect_button".to_string(), "CONNECTED!".to_string());
